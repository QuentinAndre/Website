...
I won't rehash the full debate, but one person in particular appeared to view this practice as particularly evil, calling it the "polygraph and baton of self-styled stats cops on Twitter." I happen to (strongly) disagree, and will try to make a two-part case for "circling p-values."
...
Next, is it moral? This might sound like a weird question, but the objection to "circling p-values" isn't simply a debate about the usefulness of this heuristics. It appears that people also object to this practice [because of the implication](https://www.youtube.com/watch?v=THvCDn8mGwo).
...
p-hacking is, at its core, an unavoidable consequence of hypothesis testing under uncontrolled degrees of freedom. If you are emotionally, intellectually, or personally invested in a hypothesis, and if you have uncontrolled degrees of freedom, you will p-hack your results. Like it or not. No matter how much we try to be objective, motivated reasoning and confirmation bias will always lead us to put our finger on the scale. I've written about this before, and I think it would be very helpful if we could ["de-moralize" our discussions of p-hacking]({{< ref "/post/discussing-statistical-evidence" >}}).
